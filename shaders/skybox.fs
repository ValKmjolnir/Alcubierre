...
void main() {
    ...
    vec3 gradientTop = vec3(0.2, 0.4, 0.8);         // Bright blue at top
    vec3 gradientMiddle = vec3(0.4, 0.3, 0.6);      // Purple-ish in middle
    vec3 gradientBottom = vec3(0.6, 0.4, 0.5);      // Light purplish at bottom
