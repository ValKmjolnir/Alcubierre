...
void main() {
    ...
    vec3 gradientTop = vec3(0.0, 0.2, 0.6);         // Bright blue at top
    vec3 gradientMiddle = vec3(0.2, 0.1, 0.4);      // Purple-ish in middle
    vec3 gradientBottom = vec3(0.4, 0.2, 0.3);      // Light purplish at bottom
